...
#
#  $ bin/test -s pftx.website -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src pftx.website.testing.PFTX_WEBSITE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/pftx/website/tests/robot/test_example.robot
#
